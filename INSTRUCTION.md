...
- The saved-music mini-player and expanded player use the Server player's dark/green styling and labelled icon controls. Expand for seeking, previous/next, shuffle, repeat, queue, and track information; wide layouts place artwork and controls side by side. Expanding hides the duplicate mini-player, and closing leaves the local queue and playback ownership unchanged.
