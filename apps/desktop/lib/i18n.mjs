...
const messages = {
  ...
  "shell.intro.eyebrow": { en: "YOUR SERVER LIBRARY", ko: "서버 음악 라이브러리" },
  "shell.intro.title": { en: "Server playback", ko: "서버 재생" },
  "shell.intro.detail": {
    en: "Choose a server to open its music library. Connecting never starts playback.",
    ko: "서버를 선택해 음악 라이브러리를 여세요. 연결만으로 재생이 시작되지는 않습니다.",
  },
  "shell.manual.title": { en: "Connect by address", ko: "주소로 직접 연결" },
  "shell.manual.eyebrow": { en: "MANUAL CONNECTION", ko: "직접 연결" },
  "shell.manual.cancel": { en: "Cancel", ko: "취소" },
  ...
  "shell.discovered.title": { en: "Discovered now", ko: "지금 발견한 서버" },
  "shell.discovered.detail": { en: "Verified servers on your current network.", ko: "현재 네트워크에서 확인된 서버입니다." },
  "shell.refresh": { en: "Refresh", ko: "새로 고침" },
  "shell.refreshing": { en: "Checking…", ko: "확인 중…" },
  "shell.recent.eyebrow": { en: "RECENT", ko: "최근" },
  "shell.recent.title": { en: "Recent connections", ko: "최근 연결한 서버" },
  "shell.recent.detail": { en: "Servers you connected to before. Availability is checked again.", ko: "이전에 연결한 서버입니다. 현재 연결 상태를 다시 확인합니다." },
  ...
  "main.start.data": { en: "The application data folder could not be created.\n\n{path}\n\nCheck the folder permissions and try again.", ko: "애플리케이션 데이터 폴더를 만들 수 없습니다.\n\n{path}\n\n폴더 권한을 확인한 뒤 다시 실행해 주세요." },
  ...
  "main.data.unavailable": { en: "The application data folder cannot be read or written.\n\n{path}\n\nCheck the folder permissions and try again.", ko: "애플리케이션 데이터 폴더를 읽거나 쓸 수 없습니다.\n\n{path}\n\n폴더 권한을 확인한 뒤 다시 시도해 주세요." },
  ...
  "main.recents.saveFailed": { en: "Recent server information could not be saved to the application data folder.", ko: "최근 서버 정보를 애플리케이션 데이터 폴더에 저장할 수 없습니다." },
