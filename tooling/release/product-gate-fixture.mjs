...
export const createPromotionFixture = async (root, recordedAt, observedInventory) => {
  ...
  const attestations = [
    dsse("stage/server/oci-index-provenance.json", { _type: "https://in-toto.io/Statement/v1", subject: ociSubject, predicateType: "https://slsa.dev/provenance/v1", predicate: { buildDefinition: { buildType: "https://jastreamer.invalid/build/server", resolvedDependencies: [{ uri: "git+fixture", digest: { gitCommit: identity.sourceRevision } }] }, runDetails: { builder: { id: "https://jastreamer.invalid/builder" } } } }),
  ...
  const staging = (component, runId, artifactId) => ({
    ...
    callerRunId: runId, callerRunAttempt: 1, callerRef: "refs/heads/main", callerSha: installed.receipt.source.revision, calledWorkflowPath: `.github/workflows/${component}-release.yml`, calledJob: component, calledJobResult: "success",
