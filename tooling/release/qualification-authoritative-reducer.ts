...
const parseOutputs = (value: ChildMachineOutputs, component: PublicComponent): ChildMachineOutputs => {
  ...
  if (item["calledJob"] !== component || item["calledWorkflowPath"] !== `.github/workflows/${component}-qualification-staging.yml` || item["calledOutputIdentity"] !== "jobs.stage.outputs") fail("REDUCER_OUTPUT_INVALID");
