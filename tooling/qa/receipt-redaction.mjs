...
const SECRET_VALUE = /(?:\bBearer\s+[A-Za-z0-9._~+\/-]+=*|\beyJ[A-Za-z0-9_-]+\.eyJ[A-Za-z0-9_-]+\.[A-Za-z0-9_-]+|(?:password|credential|api[_-]?key)\s*[=:]\s*\S+)/i;
...
export const findUnsafeEvidence = (value, path = "$") => {
  if (typeof value === "string") {
    ...
    if (!/^\/[A-Za-z]$/.test(value) && ABSOLUTE_PATH.test(value)) return { code: "ABSOLUTE_PATH_PRESENT", path };
